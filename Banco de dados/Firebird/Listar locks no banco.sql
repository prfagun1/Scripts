...
--Versão 02
select rdb$get_context('SYSTEM', 'DB_NAME')  as Banco, RDB$TRANSACTION_STATE as Status, RDB$TIMESTAMP as Horario, RDB$TRANSACTION_DESCRIPTION as Descricao, s.MON$SQL_TEXT as SQL, a.MON$REMOTE_ADDRESS as IP
